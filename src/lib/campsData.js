export const INITIAL_ALL_CAMPS = [
        ...
        rooms: [
            {
                ...
                name: 'Rustic Wood House (Couple Deal: ₹5,000 | Group: ₹2,200/head)',
                capacity: '2 - 6 Guests',
                price: 2200,
                couplePrice: 5000,
                totalUnits: 4,
                ...
                isAvailable: true,
                image: '/images/mini-mexico/mini-mexico-main.jpg',
                features: ['Private Wood House', 'Valley Deck', 'En-suite Restroom', 'Dinner & Breakfast Included', 'Pet Friendly', 'Couple Deal ₹5,000 / Group ₹2,200 pp']
            },
            {
                id: 'r-vattavada-cabin',
                name: 'Cozy Mountain Cabin (Couple Deal: ₹5,000 | Group: ₹2,200/head)',
                capacity: '2 - 4 Guests',
                price: 2200,
                couplePrice: 5000,
                totalUnits: 4,
            ...
            {
                id: 'r-vattavada-tent',
                name: 'Alpine Tent Camping (₹1,700 per head)',
    ...
    },
    {
        ...
        rooms: [
            {
                id: 'r-wildlink-tent',
                name: 'Standard Farm Tent Camping (₹1,699 per head)',
                capacity: '2 - 4 Campers',
                price: 1699,
                totalUnits: 12,
                bookedUnits: 2,
            ...
            {
                id: 'r-wildlink-cabin',
                name: 'Shola View Wood Cabin (Couple Deal: ₹5,000 | Group: ₹2,200/head)',
                capacity: '2 - 4 Guests',
                price: 2200,
                couplePrice: 5000,
                totalUnits: 4,
            ...
            },
            {
                ...
                name: 'Panoramic Farm Cottage (₹2,700 per head)',
                capacity: '2 - 6 Guests',
                price: 2700,
                totalUnits: 2,
                bookedUnits: 0,
