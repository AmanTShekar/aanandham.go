...
export const ROW_GAP_8 = { display: 'flex', alignItems: 'center', gap: '8px' };
export const ROW_GAP_10 = { display: 'flex', alignItems: 'center', gap: '10px' };
export const ROW_GAP_6 = { display: 'flex', alignItems: 'center', gap: '6px' };
export const ROW_SPACE = { display: 'flex', justifyContent: 'space-between', alignItems: 'center' };
