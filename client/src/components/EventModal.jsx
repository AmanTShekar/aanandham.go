                    ...
                    <div style={{ flex: 1.2, padding: '32px', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ marginTop: 'auto', paddingTop: '24px', borderTop: '1px solid #333' }}>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    alert(`Booking Request Sent to ${event.coordinator?.name || 'Organizer'}!\n\nWe will contact you shortly to confirm your spot for ${event.title}.`);
                                    onClose();
                                }}
